            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="card-title m-0">All Students</h5>
                    ...
                    <div class="card-body">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="text-success"
                                                        href="{{ route('student.show', ['id' => $item->id]) }}"> <i
                                                            class="fas  fa-2x fa-eye"></i> </a>
                                                    @if ($item->user_id == Auth::id())
                                                        &nbsp;&nbsp;
                                                        <a href="{{ route('student.edit', ['id' => $item->id]) }}"> <i
                                                                class="fas fa-2x fa-edit"></i> </a>&nbsp;&nbsp;
                                                        <a class="text-danger"
                                                            href="{{ route('student.destroy', ['id' => $item->id]) }}"> <i
                        ...
                        @endif
                        <a href="{{ route('students.trashed') }}" class="btn btn-danger">
